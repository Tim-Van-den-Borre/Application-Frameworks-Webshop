                            ...
                            <div className="modal-dialog modal-lg">
                                <div className="modal-content">
                                            ...
                                            {this.props.cartdata.map((product, index) => {
                                                return (
                                                    <ul className="list-group-item" key={index}>
                                                        ...
                                                        <button onClick={() => this.setState({ Cart: this.props.cartdata.splice(index, 1)})} type="button" className="btn btn-danger btn-sm">
                                    ...
                                    <div className="modal-footer">
                                        ...
                                        <button type="button" className="btn btn-primary btn-sm" onClick={this.placeOrder}>Plaats Order</button>
                                    </div>
                                </div>
                            </div>
                        </div>

...
class Products extends Component {
    ...
    render = () => {
        return (
            <div>
                <Navbar cartdata={this.state.Cart}/>
                            ...
                            <div className="card" key={product.id}>
                                <img className="card-img-top" src={product.image} alt="" />
                                    <div className="card-body">
                                        ...
                                        <button onClick={() => this.setState({ Cart: this.state.Cart.concat(product)})} type="button" className="btn btn-info btn-sm">
                                            ...
                                            <svg width="1em" height="1em" viewBox="0 0 16 16" className="bi bi-cart4"
